...
void HandTranslating::receiveFeatures(QString features) {
    enableToTranslate = true;
}
...
void HandTranslating::changeToTestingMode() {
    mode = TESTING_MODE;
}

bool HandTranslating::getTestingResult() {
    mode = 0;
