...
public:
    ...
    //
    void getHeightFeatures(int&,struct svm_node[]);
    //
    void getRadiusFeatures(int&,struct svm_node[]);
    //
    void getAngleFeatures(int&,struct svm_node[]);
    //
    void getLinesFeatures(int&,struct svm_node[]);
    //
